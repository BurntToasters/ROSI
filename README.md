...
## ℹ️ The Microsoft Store version of ROSI is in a seperate branch. The MS store version contains minor changes to be in compliance with the Microsoft Store. 
